...
import { currentRoute } from '@/helpers/currentRoute.js'
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink href="/agenda" :active="currentRoute() === 'agenda'">
                                    Agenda
                                </NavLink>
                                <NavLink href="/admin" :active="currentRoute() === 'admin'">
                                    Admin
                                </NavLink>
                            </div>
                        </div>
                            ...
                            <div class="ml-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <!-- Authentication -->
                                        <form @submit.prevent="logout" @click="logout">
